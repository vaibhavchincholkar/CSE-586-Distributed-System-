    ...
    private boolean testQuery() {
        try {
            for (int i = 0; i < TEST_CNT; i++) {
                ...
                Cursor resultCursor = mContentResolver.query(mUri, null, dbcontract.COLUMN_KEY, new String[]{key}, null);
               // Cursor resultCursor = mContentResolver.query(mUri, null, key, null, dbcontract.COLUMN_KEY);
